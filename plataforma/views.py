...
def pacientes(request):
    if request.method == "GET":
        ...
        #Validação para retirar os espaços em brancos    
        ...
        #Validação para verificar se o campo digitado da idade é número

        if not idade.isnumeric():
            messages.add_message(request, constants.ERROR, 'Digite uma idade válida')
            return redirect('/pacientes/')
        
        #Validadação para verificar e não cadastrar um paciente com o mesmo E-mail
